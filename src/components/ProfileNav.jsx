                ...
                ${nav ? ' pt-[5px]' : 'h-[45px]'} ${
                    ...
                    <div className=" flex justify-center">
                        <img
                            ...
                            alt="logo"
                            className={`max-w-xs rounded-full transition-all select-none duration-0 ${
                    ...
                    <ul
                        className={`mt-4 list-none flex-col text-center transition-all duration-0 ${
                            nav
                                ? 'opacity-100'
                                : 'opacity-0 pointer-events-none'
                        }`}>
                        <li className="mb-2">
                            <Link
                                ...
                                <AiOutlineHome
                                    ...
                                    size={25}
                                />
                                <h2 className="mr-3 inline-block font-bold">
                                    Home
                                </h2>
                            </Link>
                        </li>
                        <li className="mb-2">
                            <Link
                                ...
                                <AiFillProject
                                    ...
                                    size={25}
                                />
                                <h2 className="ml-4 inline-block font-bold">
                                    Projects
                                </h2>
                            </Link>
                        </li>
        ...
        return (
            ...
            scrollbar-thin  ${
                darkMode
                    ...
                    : 'bg-blue-500 scrollbar-thumb-blue-400 hover:scrollbar-thumb-blue-800'
            } `}>
